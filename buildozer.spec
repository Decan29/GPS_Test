...
requirements = python3, kivy, https://github.com/HyTurtle/plyer/archive/master.zip, chardet, idna, requests, urllib3, certifi, android, jnius, mapview, geopy, geographiclib
...
presplash.filename = %(source.dir)s/icons/appicon.png
